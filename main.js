var ci = $('.circle-icon').width();
$('.circle-icon').css({'height':ci+'px'});
$('.circle-icon').css({'line-height':ci+'px'});
...
(function(Opal) {
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$initialize', function() {
      ...
      self.board = $scope.get('Board').$new();
      return self.$set_board_pointer(self.board);
    });

    Opal.defn(self, '$set_board_pointer', function(board) {
      var $a, $b, TMP_1, self = this;

      return ($a = ($b = (0).$upto(7)).$each, $a.$$p = (TMP_1 = function(row){var self = TMP_1.$$s || this, $a, $b, TMP_2;
if (row == null) row = nil;
      return ($a = ($b = (0).$upto(7)).$each, $a.$$p = (TMP_2 = function(col){var self = TMP_2.$$s || this, $a, $b;
if (col == null) col = nil;
        if ((($a = board.$board()['$[]'](row)['$[]'](col)['$nil?']()['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            return (($a = [board]), $b = board.$board()['$[]'](row)['$[]'](col), $b['$board='].apply($b, $a), $a[$a.length-1])
            } else {
            return nil
          }}, TMP_2.$$s = self, TMP_2), $a).call($b)}, TMP_1.$$s = self, TMP_1), $a).call($b);
    });

    Opal.defn(self, '$get_piece_text', function(col, row) {
      var $a, self = this;

      if ((($a = self.board.$get_piece(col, row)['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
        return ""};
      return self.board.$get_piece(col, row).$html_text();
    });

    Opal.defn(self, '$get_piece_color', function(col, row) {
      var $a, self = this;

      if ((($a = self.board.$get_piece(col, row)['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
        return ""};
      return self.board.$get_piece(col, row).$color();
    });

    Opal.defn(self, '$valid_move', function(current_col, current_row, target_col, target_row) {
      var self = this;

      return self.board.$get_piece(current_col, current_row).$possible_moves()['$include?'](self.board.$convert_to_move(target_col, target_row));
    });
  ...
  (function($base, $super) {
    ...
    def.color = def.board = def.reach = def.location = def.possible_directions = nil;
    self.$attr_accessor("location", "board", "html_text");

    self.$attr_reader("color", "piece");
    ...
    Opal.defn(self, '$initialize', function(location, color) {
      ...
      self.color = color;
      self.reach = 1;
      self.possible_directions = ["north", "south", "east", "west", "northeast", "northwest", "southeast", "southwest"];
      self.piece = "";
      return self.board = nil;
    });

    Opal.defn(self, '$my_king', function() {
      var self = this;

      if (self.color['$==']("black")) {
        return self.board.$black_king()};
      if (self.color['$==']("white")) {
        return self.board.$white_king()
        } else {
        return nil
      };
    });
    ...
    Opal.defn(self, '$eql?', function(other) {
      ...
      return ($a = (self.$class()['$=='](other.$class())), $a !== false && $a !== nil ?(self.color['$=='](other.$piece_color())) : $a);
    });
    ...
    Opal.defn(self, '$move_to', function(row, col) {
      ...
      return (($a = [[row, col]]), $b = current_piece, $b['$location='].apply($b, $a), $a[$a.length-1]);
    });

    Opal.defn(self, '$occupied_targets', function() {
      var self = this;

      return self.board.$occupied_targets();
    });

    Opal.defn(self, '$enemies_of', function(piece) {
      var $a, $b, TMP_3, $c, $d, TMP_4, self = this;

      return ($a = ($b = ($c = ($d = self.$occupied_targets()).$map, $c.$$p = (TMP_4 = function(target){var self = TMP_4.$$s || this;
        if (self.board == null) self.board = nil;
if (target == null) target = nil;
      return self.board.$piece_at(target['$[]'](0), target['$[]'](1))}, TMP_4.$$s = self, TMP_4), $c).call($d)).$select, $a.$$p = (TMP_3 = function(target){var self = TMP_3.$$s || this;
if (target == null) target = nil;
      return target['$enemy_of?'](piece)}, TMP_3.$$s = self, TMP_3), $a).call($b);
    });
...
if (num == null) num = nil;
      return moves['$<<'](num)}, TMP_5.$$s = self, TMP_5), $a).call($b, self.reach['$-@']());
...
if (num == null) num = nil;
      ...
      moves = self.$apply_directions(moves);
      moves = self.$apply_location(moves);
      return moves = self.$apply_board_limits(moves);
    });
...
if (occ_target == null) occ_target = nil;
    ...
    Opal.defn(self, '$enemy_of?', function(other_piece) {
      var $a, self = this;

      if ((($a = other_piece['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
        return false};
...
if (move == null) move = nil;
    ...
    Opal.defn(self, '$same_direction?', function(first_target, second_target, relation) {
      var $a, $b, self = this;

      if ((($a = ($b = self['$north_of?'](first_target, relation), $b !== false && $b !== nil ?self['$north_of?'](second_target, relation) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return true};
      if ((($a = ($b = self['$south_of?'](first_target, relation), $b !== false && $b !== nil ?self['$south_of?'](second_target, relation) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return true};
      if ((($a = ($b = self['$east_of?'](first_target, relation), $b !== false && $b !== nil ?self['$east_of?'](second_target, relation) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return true};
      if ((($a = ($b = self['$west_of?'](first_target, relation), $b !== false && $b !== nil ?self['$west_of?'](second_target, relation) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return true};
      if ((($a = ($b = self['$northeast_of?'](first_target, relation), $b !== false && $b !== nil ?self['$northeast_of?'](second_target, relation) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return true};
      if ((($a = ($b = self['$northwest_of?'](first_target, relation), $b !== false && $b !== nil ?self['$northwest_of?'](second_target, relation) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return true};
      if ((($a = ($b = self['$southeast_of?'](first_target, relation), $b !== false && $b !== nil ?self['$southeast_of?'](second_target, relation) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return true};
      if ((($a = ($b = self['$southwest_of?'](first_target, relation), $b !== false && $b !== nil ?self['$southwest_of?'](second_target, relation) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return true};
      return false;
    });

    Opal.defn(self, '$further_than?', function(first_target, second_target, relation) {
      var $a, $b, self = this;

      if ((($a = self['$same_direction?'](first_target, second_target, relation)['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
        return false};
      if ((($a = ($b = self['$north_of?'](first_target, relation), $b !== false && $b !== nil ?(self['$north_of?'](second_target, first_target)) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return true};
      if ((($a = ($b = self['$south_of?'](first_target, relation), $b !== false && $b !== nil ?(self['$south_of?'](second_target, first_target)) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return true};
      if ((($a = ($b = self['$west_of?'](first_target, relation), $b !== false && $b !== nil ?(self['$west_of?'](second_target, first_target)) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return true};
      if ((($a = ($b = self['$east_of?'](first_target, relation), $b !== false && $b !== nil ?(self['$east_of?'](second_target, first_target)) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return true};
      if ((($a = ($b = self['$northeast_of?'](first_target, relation), $b !== false && $b !== nil ?(self['$northeast_of?'](second_target, first_target)) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return true};
      if ((($a = ($b = self['$northwest_of?'](first_target, relation), $b !== false && $b !== nil ?(self['$northwest_of?'](second_target, first_target)) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return true};
      if ((($a = ($b = self['$southeast_of?'](first_target, relation), $b !== false && $b !== nil ?(self['$southeast_of?'](second_target, first_target)) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return true};
      if ((($a = ($b = self['$southwest_of?'](first_target, relation), $b !== false && $b !== nil ?(self['$southwest_of?'](second_target, first_target)) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return true};
      return false;
    });

    Opal.defn(self, '$checkable_move?', function(row, col) {
    ...
    Opal.defn(self, '$diagonal_of?', function(target, current) {
      var $a, self = this;

      return ((($a = ($rb_minus(target['$[]'](0), current['$[]'](0)))['$=='](($rb_minus(target['$[]'](1), current['$[]'](1))))) !== false && $a !== nil) ? $a : $rb_times(($rb_minus(target['$[]'](0), current['$[]'](0))), -1)['$=='](($rb_minus(target['$[]'](1), current['$[]'](1)))));
    });

    Opal.defn(self, '$north_of?', function(target, current) {
      var $a, self = this;

      return ($a = $rb_gt(target['$[]'](0), current['$[]'](0)), $a !== false && $a !== nil ?target['$[]'](1)['$=='](current['$[]'](1)) : $a);
    });

    Opal.defn(self, '$south_of?', function(target, current) {
      var $a, self = this;

      return ($a = $rb_lt(target['$[]'](0), current['$[]'](0)), $a !== false && $a !== nil ?target['$[]'](1)['$=='](current['$[]'](1)) : $a);
    });

    Opal.defn(self, '$east_of?', function(target, current) {
      var $a, self = this;

      return ($a = $rb_gt(target['$[]'](1), current['$[]'](1)), $a !== false && $a !== nil ?target['$[]'](0)['$=='](current['$[]'](0)) : $a);
    });

    Opal.defn(self, '$west_of?', function(target, current) {
      var $a, self = this;

      return ($a = $rb_lt(target['$[]'](1), current['$[]'](1)), $a !== false && $a !== nil ?target['$[]'](0)['$=='](current['$[]'](0)) : $a);
    });

    Opal.defn(self, '$northeast_of?', function(target, current) {
      var $a, $b, self = this;

      return ($a = ($b = self['$diagonal_of?'](target, current), $b !== false && $b !== nil ?$rb_gt(target['$[]'](0), current['$[]'](0)) : $b), $a !== false && $a !== nil ?$rb_gt(target['$[]'](1), current['$[]'](1)) : $a);
    });

    Opal.defn(self, '$northwest_of?', function(target, current) {
      var $a, $b, self = this;

      return ($a = ($b = self['$diagonal_of?'](target, current), $b !== false && $b !== nil ?$rb_gt(target['$[]'](0), current['$[]'](0)) : $b), $a !== false && $a !== nil ?$rb_lt(target['$[]'](1), current['$[]'](1)) : $a);
    });

    Opal.defn(self, '$southeast_of?', function(target, current) {
      var $a, $b, self = this;

      return ($a = ($b = self['$diagonal_of?'](target, current), $b !== false && $b !== nil ?$rb_lt(target['$[]'](0), current['$[]'](0)) : $b), $a !== false && $a !== nil ?$rb_gt(target['$[]'](1), current['$[]'](1)) : $a);
    });

    Opal.defn(self, '$southwest_of?', function(target, current) {
      var $a, $b, self = this;

      return ($a = ($b = self['$diagonal_of?'](target, current), $b !== false && $b !== nil ?$rb_lt(target['$[]'](0), current['$[]'](0)) : $b), $a !== false && $a !== nil ?$rb_lt(target['$[]'](1), current['$[]'](1)) : $a);
    });

    Opal.defn(self, '$cardinal_move?', function(move) {
      var $a, $b, $c, self = this;

      return ((($a = ((($b = ((($c = self['$northern_move?'](move)) !== false && $c !== nil) ? $c : self['$southern_move?'](move))) !== false && $b !== nil) ? $b : self['$western_move?'](move))) !== false && $a !== nil) ? $a : self['$eastern_move?'](move));
    });

    Opal.defn(self, '$northern_move?', function(move) {
      var $a, self = this;

      return ($a = $rb_ge(move['$[]'](0), 1), $a !== false && $a !== nil ?move['$[]'](1)['$=='](0) : $a);
    });

    Opal.defn(self, '$southern_move?', function(move) {
      var $a, self = this;

      return ($a = $rb_le(move['$[]'](0), -1), $a !== false && $a !== nil ?move['$[]'](1)['$=='](0) : $a);
    });

    Opal.defn(self, '$eastern_move?', function(move) {
      var $a, self = this;

      return ($a = $rb_ge(move['$[]'](1), 1), $a !== false && $a !== nil ?move['$[]'](0)['$=='](0) : $a);
    });

    Opal.defn(self, '$western_move?', function(move) {
      var $a, self = this;

      return ($a = $rb_le(move['$[]'](1), -1), $a !== false && $a !== nil ?move['$[]'](0)['$=='](0) : $a);
    });

    Opal.defn(self, '$northeastern_move?', function(move) {
      var $a, self = this;

      return ($a = $rb_ge(move['$[]'](0), 1), $a !== false && $a !== nil ?$rb_ge(move['$[]'](1), 1) : $a);
    });

    Opal.defn(self, '$northwestern_move?', function(move) {
      var $a, self = this;

      return ($a = $rb_ge(move['$[]'](0), 1), $a !== false && $a !== nil ?$rb_le(move['$[]'](1), -1) : $a);
    });

    Opal.defn(self, '$southeastern_move?', function(move) {
      var $a, self = this;

      return ($a = $rb_le(move['$[]'](0), -1), $a !== false && $a !== nil ?$rb_ge(move['$[]'](1), 1) : $a);
    });

    Opal.defn(self, '$southwestern_move?', function(move) {
      var $a, self = this;

      return ($a = $rb_le(move['$[]'](0), -1), $a !== false && $a !== nil ?$rb_le(move['$[]'](1), -1) : $a);
    });

    Opal.defn(self, '$can_move_north?', function() {
      var self = this;

      return self.possible_directions['$include?']("north");
    });

    Opal.defn(self, '$can_move_south?', function() {
      var self = this;

      return self.possible_directions['$include?']("south");
    });

    Opal.defn(self, '$can_move_east?', function() {
      var self = this;

      return self.possible_directions['$include?']("east");
    });

    Opal.defn(self, '$can_move_west?', function() {
      var self = this;

      return self.possible_directions['$include?']("east");
    });

    Opal.defn(self, '$can_move_northeast?', function() {
      var self = this;

      return self.possible_directions['$include?']("northeast");
    });

    Opal.defn(self, '$can_move_northwest?', function() {
      var self = this;

      return self.possible_directions['$include?']("northwest");
    });

    Opal.defn(self, '$can_move_southeast?', function() {
      var self = this;

      return self.possible_directions['$include?']("southeast");
    });

    return (Opal.defn(self, '$can_move_southwest?', function() {
      var self = this;

      return self.possible_directions['$include?']("southwest");
    }), nil) && 'can_move_southwest?';
  })($scope.base, null);
  (function($base, $super) {
    function $Pawn(){};
    var self = $Pawn = $klass($base, $super, 'Pawn', $Pawn);
    ...
    Opal.defn(self, '$initialize', function(location, color) {
      ...
      self.color = color;
      self.reach = 1;
      self.possible_directions = ["north"];
      self.piece = "♟";
      self.board = nil;
      self.row_loc = self.location['$[]'](0);
      self.col_loc = self.location['$[]'](1);
      self.has_moved = false;
      return self.html_text = "&#9823";
    });
    ...
    Opal.defn(self, '$possible_moves', function() {
      ...
      if (self.color['$==']("black")) {
        ...
        northern_space = self.board.$piece_at(($rb_minus(self.row_loc, 1)), self.col_loc);
      ...
      if ((($a = ($b = northern_space['$nil?'](), $b !== false && $b !== nil ?self.color['$==']("black") : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        moves['$<<']([($rb_minus(self.row_loc, 1)), (self.col_loc)])};
      if ((($a = ($b = (northeastern_space['$nil?']()['$!']()), $b !== false && $b !== nil ?northeastern_space['$enemy_of?'](current_piece) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        moves['$<<'](northeastern_space.$location())};
      if ((($a = ($b = (northwestern_space['$nil?']()['$!']()), $b !== false && $b !== nil ?northwestern_space['$enemy_of?'](current_piece) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        moves['$<<'](northwestern_space.$location())};
      if ((($a = ($b = ($c = (self.has_moved['$!']()), $c !== false && $c !== nil ?(two_in_front)['$nil?']() : $c), $b !== false && $b !== nil ?(self.color['$==']("black")) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        moves['$<<']([($rb_minus(self.row_loc, 2)), (self.col_loc)])};
  ...
  (function($base, $super) {
    function $Knight(){};
    var self = $Knight = $klass($base, $super, 'Knight', $Knight);
...
if (move == null) move = nil;
  ...
  (function($base, $super) {
    function $Bishop(){};
    var self = $Bishop = $klass($base, $super, 'Bishop', $Bishop);

    var def = self.$$proto, $scope = self.$$scope;

    self.$attr_reader("html_text");

    return (Opal.defn(self, '$initialize', function(location, color) {
      var self = this;
      ...
      self.color = color;
      self.reach = 7;
      self.possible_directions = ["northeast", "northwest", "southeast", "southwest"];
      self.piece = "♝";
      self.board = nil;
      return self.html_text = "&#9821";
    }), nil) && 'initialize';
  })($scope.base, $scope.get('Piece'));
  (function($base, $super) {
    function $Rook(){};
    var self = $Rook = $klass($base, $super, 'Rook', $Rook);
    ...
    return (Opal.defn(self, '$initialize', function(location, color) {
      ...
      self.color = color;
      self.reach = 7;
      self.possible_directions = ["north", "south", "east", "west"];
      self.piece = "♜";
      self.board = nil;
      return self.html_text = "&#9820";
    }), nil) && 'initialize';
  })($scope.base, $scope.get('Piece'));
  (function($base, $super) {
    function $Queen(){};
    var self = $Queen = $klass($base, $super, 'Queen', $Queen);
    ...
    return (Opal.defn(self, '$initialize', function(location, color) {
      ...
      self.piece = "♛";
      self.board = nil;
      return self.html_text = "&#9819";
    }), nil) && 'initialize';
  })($scope.base, $scope.get('Piece'));
  (function($base, $super) {
    function $King(){};
    var self = $King = $klass($base, $super, 'King', $King);
...
if (num == null) num = nil;
    ...
    Opal.defn(self, '$my_enemies', function() {
      var self = this, me = nil;

      me = self.board.$piece_at(self.location['$[]'](0), self.location['$[]'](1));
...
if (col == null) col = nil;
    ...
    Opal.defn(self, '$convert_to_move', function(col, row) {
      var self = this, cols = nil;

      cols = $hash2(["a", "b", "c", "d", "e", "f", "g", "h"], {"a": 0, "b": 1, "c": 2, "d": 3, "e": 4, "f": 5, "g": 6, "h": 7});
      row = $rb_minus(row, 1);
      col = cols['$[]'](col);
      return [row, col];
    });

    Opal.defn(self, '$get_piece', function(col, row) {
      var self = this, cols = nil;

      cols = $hash2(["a", "b", "c", "d", "e", "f", "g", "h"], {"a": 0, "b": 1, "c": 2, "d": 3, "e": 4, "f": 5, "g": 6, "h": 7});
      row = $rb_minus(row, 1);
      col = cols['$[]'](col);
      return self.$piece_at(row, col);
    });

    Opal.defn(self, '$set_piece', function(piece, col, row) {
      var self = this, cols = nil;

      cols = $hash2(["a", "b", "c", "d", "e", "f", "g", "h"], {"a": 0, "b": 1, "c": 2, "d": 3, "e": 4, "f": 5, "g": 6, "h": 7});
      row = $rb_minus(row, 1);
      col = cols['$[]'](col);
      return piece.$move_to(row, col);
    });
    ...
    Opal.defn(self, '$space_equals', function(row, col, data) {
      ...
      return self.board['$[]'](row)['$[]='](col, data);
    });

    Opal.defn(self, '$occupied_targets', function() {
      var $a, $b, TMP_38, self = this, occupied_targets = nil;

      occupied_targets = [];
      ($a = ($b = (0).$upto(7)).$each, $a.$$p = (TMP_38 = function(row){var self = TMP_38.$$s || this, $a, $b, TMP_39;
if (row == null) row = nil;
      return ($a = ($b = (0).$upto(7)).$each, $a.$$p = (TMP_39 = function(column){var self = TMP_39.$$s || this, $a;
          if (self.board == null) self.board = nil;
if (column == null) column = nil;
        if ((($a = self.board['$[]'](row)['$[]'](column)['$nil?']()['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            return occupied_targets['$<<']([row, column])
            } else {
            return nil
          }}, TMP_39.$$s = self, TMP_39), $a).call($b)}, TMP_38.$$s = self, TMP_38), $a).call($b);
...
if (index == null) index = nil;
    ...
    Opal.defn(self, '$set_nobles', function() {
      ...
      self.$set_white_nobles();
      return self.$set_black_nobles();
    });
    ...
    if (myTail.innerHTML === "") {
      ...
      event.currentTarget.innerHTML = ""; } else {
        ...
        if(myboolean) {
          ...
          console.log("after set piece before change class")
          change_class(myTail, event.currentTarget)
          console.log("after change class")
